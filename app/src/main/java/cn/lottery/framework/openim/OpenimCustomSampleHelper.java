...
import cn.lottery.framework.openim.tribe.OpenimSendAtMsgDetailUISample;
 ...
 * @author zhaoxu
 */
public class OpenimCustomSampleHelper {

    private static String TAG=OpenimCustomSampleHelper.class.getSimpleName();
    ...
    public static void initCustom() {
        ...
        //@消息界面
        AdviceBinder.bindAdvice(PointCutEnum.TRIBE_FRAGMENT_AT_MSG_DETAIL, OpenimSendAtMsgDetailUISample.class);
        AdviceBinder.bindAdvice(PointCutEnum.TRIBE_ACTIVITY_AT_MSG_LIST, OpenimAtMsgListUISample.class);
        AdviceBinder.bindAdvice(PointCutEnum.TRIBE_ACTIVITY_SELECT_AT_MEMBER, OpenimSelectTribeAtMemberSample.class);
        AdviceBinder.bindAdvice(PointCutEnum.TRIBE_ACTIVITY_AT_MSG_LIST_OP, OpenimAtMsgListOperationSample.class);
