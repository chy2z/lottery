package cn.lottery.framework.openim.tribe;
 ...
 */
public class OpenimSendAtMsgDetailUISample extends IMTribeAtPageUI {

    public OpenimSendAtMsgDetailUISample(Pointcut pointcut){
        super(pointcut);
    }
    ...
    public View getCustomTitle(final Fragment fragment, final Context context, LayoutInflater layoutInflater) {
        RelativeLayout customView = (RelativeLayout) layoutInflater
                .inflate(R.layout.openim_custom_at_msg_titlebar, null);
        customView.setBackgroundColor(context.getResources().getColor(R.color.title_bg));
        ...
        title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Toast.makeText(context, "click OpenimSendAtMsgDetailUISample", Toast.LENGTH_SHORT).show();
            }
        });
        TextView backButton = (TextView) customView.findViewById(R.id.left_button);
        backButton.setCompoundDrawablesWithIntrinsicBounds(R.drawable.openim_common_back_btn_white, 0, 0, 0);
