 ...
 */
public class OpenimAtMsgListUISample extends IMTribeAtPageUI {

    public OpenimAtMsgListUISample(Pointcut pointcut){
        super(pointcut);
    }
...
//        return super.getCustomEmptyViewInTribeAtMsgList(context);
        return LayoutInflater.from(context).inflate(R.layout.openim_custom_at_msg_list_empty_view, null);
    }
}
