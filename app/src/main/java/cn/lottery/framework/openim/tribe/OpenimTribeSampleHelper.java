 ...
 * 
 */
public class OpenimTribeSampleHelper {
	...
	public static IYWTribeService getTribeService() {
		final YWIMKit imKit = OpenIMLoginHelper.getInstance().getIMKit();
		if (imKit != null) {
	...
	public static void createTribe_Sample(YWTribeType tribeType){
		...
		if (tribeType == YWTribeType.CHATTING_GROUP){ //讨论组
			//讨论组需要指定用户
			final List<String> userList = new ArrayList<String>();
			final YWIMCore core = OpenIMLoginHelper.getInstance().getIMKit()
					.getIMCore();
