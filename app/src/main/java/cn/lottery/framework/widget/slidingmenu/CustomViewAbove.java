package cn.lottery.framework.widget.slidingmenu;
...
import cn.lottery.framework.widget.slidingmenu.SlidingMenu.OnClosedListener;
import cn.lottery.framework.widget.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	float distanceInfluenceForSnapDuration(float f) {
		...
		f *= 0.3f * Math.PI / 2.0f;
		return (float) Math.sin(f); //FloatMath.sin(f); //6.0 FloatMath.sin(f) 报错
	}
