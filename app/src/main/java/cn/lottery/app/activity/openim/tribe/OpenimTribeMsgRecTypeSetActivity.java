 ...
 * 群消息状态设置
 */
public class OpenimTribeMsgRecTypeSetActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.openim_activity_tribe_msg_rec_type_set);
        initTitle();
    ...
    private void initTitle() {
        ...
        titleView.setBackgroundColor(Color.parseColor("#f4bc1a")); //#00b4ff
    ...
    public static Intent getTribeMsgRecTypeSetActivityIntent(Context context, int flag) {
        Intent intent = new Intent(context, OpenimTribeMsgRecTypeSetActivity.class);
