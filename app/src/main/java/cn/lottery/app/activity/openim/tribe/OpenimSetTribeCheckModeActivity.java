 ...
 *  加群限制配置
 */
public class OpenimSetTribeCheckModeActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.openim_activity_set_tribe_check_mode);
        initView();
        ...
        mTribeService.modifyTribeCheckMode(new IWxCallback() {
            ...
            public void onSuccess(Object... result) {
                mUIHandler.post(new Runnable() {
                    ...
                    public void run() {
                        updateCheckModeView(checkMode);
                        IMNotificationUtils.getInstance().showToast("修改群验证模式成功", OpenimSetTribeCheckModeActivity.this);
                        onBackPressed();
                    }
                });
            }
            ...
            public void onError(int code, String info) {
                IMNotificationUtils.getInstance().showToast(TribeErrInfo.codeToInfo(code), OpenimSetTribeCheckModeActivity.this);
            }
    ...
    private void showPwdDialog(){
        final View view = getLayoutInflater().inflate(R.layout.openim_dialog_set_tribe_pwd, null);
    ...
    private void initTribeChangeListener() {
        mTribeChangeListener = new IYWTribeChangeListener() {
            ...
            public void onUserRemoved(YWTribe tribe, YWTribeMember user) {
                ...
                IMNotificationUtils.getInstance().showToast(message, OpenimSetTribeCheckModeActivity.this);
            ...
            public void onTribeRoleChanged(YWTribe tribe, YWTribeMember user) {
                ...
                if (mIMKit.getIMCore().getLongLoginUserId().equals(AccountInfoTools.getPrefix(user.getAppKey() + user.getUserId()))
                    ...
                    IMNotificationUtils.getInstance().showToast("您已被取消管理员", OpenimSetTribeCheckModeActivity.this);
                    finish();
                }
            }
        };
