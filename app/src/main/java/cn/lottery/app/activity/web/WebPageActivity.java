 ...
 */
public class WebPageActivity extends BaseActivity implements View.OnClickListener,UploadUtils.OnUploadProcessListener,AliPay.onAliPay {

    String webtestUrl="http://192.168.1.104/showlife/kamang.html";
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    webview.loadUrl("javascript: getBackRedirectURL()");
                }
            });
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {  //获取登录用户信息
                ...
                toast("正在打开支付宝");
                AliPay.setOnAliPay(WebPageActivity.this);
                ...
                if(accountId.equals(Config.IMUserId)){
                    ...
                    final AlertDialog myDialog = new AlertDialog.Builder(WebPageActivity.this,AlertDialog.THEME_HOLO_LIGHT).create();
                    myDialog.show();
                        ...
                        public void onClick(View v) {
                            if(edMsg.getText().toString().equals("")){
                                ...
                                contactService.addContact(accountId, OpenIMLoginHelper.APP_KEY, Config.nickname,edMsg.getText().toString(), new IWxCallback() {
                                    ...
                                    @Override
                                    public void onError(int code, String info) {
                                        IMNotificationUtils.getInstance().showToast(WebPageActivity.this, "好友申请失败，code = " + code + ", info = " + info);
                                    }
    ...
    final class MyWebChromeClient extends WebChromeClient {
        ...
        public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
            result.confirm();
            Toast.makeText(WebPageActivity.this, message, Toast.LENGTH_SHORT).show();
            return true;
        }
    }
    ...
    public void uploadProcess(int uploadSize) {
        if (ufileSize != 0) {
            ...
            if(uploadProcess!=pro){
                uploadProcess=pro;
                if (pro==100){
                    //Toast.makeText(WebPageActivity.this,"第"+countPhotos+"张图片,进度:" + pro + "%", Toast.LENGTH_SHORT).show();
                    //Toast.makeText(WebPageActivity.this,"第"+(countPhotos+1)+"张图片上传成功" , Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    private  void processImages(JSONObject json) {
        try {
            ...
            if(msg.getBoolean("success")) {
                ...
                Intent intent = new Intent(WebPageActivity.this, TraceDynamicImageActivity.class);
