 ...
 * 群成员数据适配器
 */
public class OpenimTribeMembersAdapterSample extends YWAsyncBaseAdapter {
    ...
    public OpenimTribeMembersAdapterSample(Activity context, List<YWTribeMember> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.openim_tribe_members_item, null);
