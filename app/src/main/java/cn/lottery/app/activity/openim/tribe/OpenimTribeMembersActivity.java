...
import cn.lottery.R;
import cn.lottery.app.activity.openim.OpenimFragmentTabs;
 ...
 * 群成员列表
 */
public class OpenimTribeMembersActivity extends Activity implements AdapterView.OnItemLongClickListener {
    ...
    private OpenimTribeMembersAdapterSample mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.openim_activity_tribe_members);
        init();
    }
    ...
    private void init() {
        ...
        mAdapter = new OpenimTribeMembersAdapterSample(this, mList);
        ...
        mAddTribeMembers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(OpenimTribeMembersActivity.this, OpenimInviteTribeMemberActivity.class);
    ...
    private void initTitle() {
        ...
        view.setBackgroundColor(getResources().getColor(R.color.title_bg));//Color.parseColor("#00b4ff")
        ...
        rightButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tribe.getTribeType() == YWTribeType.CHATTING_TRIBE && getLoginUserRole() == YWTribeMember.ROLE_NORMAL) {
                    IMNotificationUtils.getInstance().showToast(OpenimTribeMembersActivity.this, "您不是群管理员，没有管理权限~");
                } else {
    ...
    private void getTribeMembers() {
        mTribeService.getMembers(new IWxCallback() {
            ...
            public void onError(int code, String info) {
                ...
                IMNotificationUtils.getInstance().showToast(OpenimTribeMembersActivity.this, "error, code = " + code + ", info = " + info);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (items[which].equals(TribeConstants.TRIBE_SET_MANAGER)){
                            ...
                            mTribeService.expelMember(mTribeId, member, new IWxCallback() {
                                @Override
                                public void onSuccess(Object... result) {
                                    IMNotificationUtils.getInstance().showToast(OpenimTribeMembersActivity.this, "踢人成功！");
                                    mList.remove(member);
                                    refreshAdapter();
                                }
    ...
    private void ShowInviteToJoinTribeDialog(){
        View view = View.inflate(this, R.layout.openim_dialog_invite_tribe_member, null);
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (TextUtils.isEmpty(userId) || TextUtils.isEmpty(appKey)){
                            IMNotificationUtils.getInstance().showToast(OpenimTribeMembersActivity.this, "userId 和 appKey 均不能为空！");
                            return;
                        }
    ...
    private void inviteTribeMembers(List<IYWContact> contacts){
        mTribeService.inviteMembers(mTribeId, contacts, new IWxCallback() {
            ...
            public void onSuccess(Object... result) {
                ...
                if (retCode == 0){
                    ...
                    if (tribe.getTribeType() == YWTribeType.CHATTING_GROUP) {
                        IMNotificationUtils.getInstance().showToast(OpenimTribeMembersActivity.this, "添加群成员成功！");
                    } else {
                        IMNotificationUtils.getInstance().showToast(OpenimTribeMembersActivity.this, "群邀请发送成功！");
                    }
                    finish();
                }
            }
            ...
            @Override
            public void onError(int code, String info) {
                IMNotificationUtils.getInstance().showToast(OpenimTribeMembersActivity.this, "添加群成员失败，code = " + code + ", info = " + info);
            }
