...
import cn.lottery.R;
import cn.lottery.app.activity.openim.web.OpenimSimpleWebViewActivity;
...
import cn.lottery.framework.openim.OpenimSimpleKVStore;

/**
 * Created by admin on 2017/4/25.
 */
public class OpenimMoreFragment extends Fragment implements View.OnClickListener {

    private static final String TAG = OpenimMoreFragment.class
            .getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.openim_fragment_more, container, false);
        init();
        return mView;
    }
    ...
    private void updateNotificationSettings(){
        soundCheckBox.setChecked(OpenimSimpleKVStore.getNeedSound() == 1);
        vibrationCheckBox.setChecked(OpenimSimpleKVStore.getNeedVibration() == 1);
    }
...
//                imKit = LoginSampleHelper.getInstance().getIMKit();
            ...
            case R.id.more_upload_log:
                ...
                IYWDebugToolService debugToolService = OpenIMLoginHelper.getInstance().getIMKit().getDebugToolService();
            ...
            case R.id.setting_sound_layout:
                ...
                OpenimSimpleKVStore.setNeedSound(!oldCheck? 1:0);
            ...
            case R.id.setting_vibration_layout:
                ...
                OpenimSimpleKVStore.setNeedVibration(!oldCheck ? 1 : 0);
                break;
    ...
    private void viewUrlInSimpleWebView(String url, String title) {
        Intent intent = new Intent(getActivity(), OpenimSimpleWebViewActivity.class);
        intent.putExtra(OpenimSimpleWebViewActivity.URL, url);
        intent.putExtra(OpenimSimpleWebViewActivity.TITLE, title);
        startActivity(intent);
    }
