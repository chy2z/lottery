 ...
 * 添加群成员
 */
public class OpenimInviteTribeMemberActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.openim_activity_invite_tribe_member);
    ...
    private void initTitle(){
        ...
        titleBar.setBackgroundColor(getResources().getColor(R.color.title_bg)); //Color.parseColor("#00b4ff")
                ...
                if (list != null && list.size() > 0){
                    mTribeService.inviteMembers(mTribeId, list, new IWxCallback() {
                           ...
                           Integer retCode = (Integer) result[0];
                            if (retCode == 0){
                                if (tribeType == YWTribeType.CHATTING_GROUP) {
                                    IMNotificationUtils.getInstance().showToast(OpenimInviteTribeMemberActivity.this, "添加群成员成功！");
                                } else {
                                    IMNotificationUtils.getInstance().showToast(OpenimInviteTribeMemberActivity.this, "群邀请发送成功！");
                                }
                                finish();
                            }
                        }
                        ...
                        public void onError(int code, String info) {
                            IMNotificationUtils.getInstance().showToast(OpenimInviteTribeMemberActivity.this, "添加群成员失败，code = " + code + ", info = " + info);
                        }
