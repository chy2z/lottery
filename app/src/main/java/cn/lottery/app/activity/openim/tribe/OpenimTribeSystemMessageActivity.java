 ...
 * 群系统消息
 */
public class OpenimTribeSystemMessageActivity extends BaseOpenimActivity {

    private YWIMKit mIMKit;
    private OpenimTribeSystemMessageAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.openim_activity_system_message);
        init();
    }
    ...
    private void init(){
        ...
        mAdapter = new OpenimTribeSystemMessageAdapter(this, mList);
    ...
    private void initTitle() {
        ...
        titleBar.setBackgroundColor(getResources().getColor(R.color.title_bg)); //#00b4ff
