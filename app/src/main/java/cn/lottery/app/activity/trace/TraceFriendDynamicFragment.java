 ...
 */
public class TraceFriendDynamicFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {

    private String TAG = TraceFriendDynamicFragment.class.getSimpleName();
     ...
     * 获取好友动态信息
     */
    private void requestFriendDynamic(){
        HashMap<String, String> params = new HashMap<String, String>();
        params.put("userId",Config.customerID);
        params.put("user_token",Config.userToken);
        showLoadingDialog();
        post(Config.URL_PREFIX + RequestUrl.getFriendDynamic, params, null,"requestFriendDynamic");
    }
    ...
    protected void handSuccess(JSONObject obj, Object tag) {
        if (tag.equals("requestFriendDynamic")) {
            closeDialog();
            processFriendDynamic(obj);
        }
     ...
     * @param json
     */
    private void processFriendDynamic(JSONObject json) {
        try {
            ...
            lvAdapter = new HomePageDynamicListViewAdapter(getContext(),HomePageDynamicListViewAdapter.Friend_Type, dataLV,app.getImageLoader());
