 ...
 */
public class TraceNearDynamicFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {

    private String TAG = TraceNearDynamicFragment.class.getSimpleName();
    ...
    private void processDynamic(JSONObject json) {
        try {
            ...
            lvAdapter = new HomePageDynamicListViewAdapter(getContext(),HomePageDynamicListViewAdapter.Default_Type, dataLV,app.getImageLoader());
